...
const FeatureList: FeatureItem[] = [
  {
    title: "バッチモードの使い方を解説",
    Svg: require("@site/static/img/batch.svg").default,
    description: (
      <>
  ...
  {
    title: "SSHでのリモート操作",
    Svg: require("@site/static/img/ssh.svg").default,
    description: (
      <>
  ...
  },
  {
    ...
    Svg: require("@site/static/img/tut.svg").default,

    description: (
      <>
        Vivadoのバッチモードを使って、独自IPモジュールを用いたBlock
        Designの作成までを解説します。
      </>
    ),
  },
